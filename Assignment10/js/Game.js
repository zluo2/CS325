...
MyGame.Game.prototype = {
  create: function() {
    ...
    this.proName = this.add.text(game.world.width/2,46,'Kings Road',{font: "bold 38px Microsoft YaHei", fill: "#5b3716",align:'center'})
    ...
    this.startBtn = this.add.button(120,450,'ico',function(){
